...
export default function Footer() {
  ...
  return (
    <footer className="relative bottom-0 w-full h-28 bg-gray-400">
      <nav className=" w-full h-full flex justify-evenly items-center" >
          {socials.map((s, i) =>(
          <a key={i} href={s.url} className=" w-10 h-10 md:w-16 md:h-16 transition-transform duration-300 ease-in-out hover:transform hover:scale-105 text-yellow-300 hover:text-black">
